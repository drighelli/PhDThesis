...
The nature of the data, in count format, makes it possible to apply several well known RNA-Seq normalizations techniques, such as \textit{TMM}, \textit{upper-quartile}, \textit{full-quantile}, \textit{RUV-Seq}, etc \cite{Risso2014, Robinson2010, Dillies2013}.
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth, height=\textheight, keepaspectratio]{img/descan2/normalizations_nullds_vs_fullds.png}
...
\textbf{UNFORTUNATELY BECAUSE OF AN ERROR IN THE SCRIPT I'M GENERATING THE NULL DATASET COUNTS AGAIN... further conclusion needed on this figure}
%\begin{figure}[H]
%\centering
...
Figure 	\ref{fig:depeakdegenessdescan} illustrates with green circles the peaks with an annotated gene with distance lower than 10000bp from the gene \gls{tss}.
...
\textbf{Insert tables for the functional results, and discuss with Lucia or Valerio.}
