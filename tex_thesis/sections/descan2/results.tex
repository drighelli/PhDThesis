...
In this case, decided to use \textit{edgeR} package, because of its wide range ofavailable  statistical methods and the possibility to better tune the design of the experiment. 
