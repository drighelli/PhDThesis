...
The internal volume is defined by the \textit{cytoplasm}, which is a liquid solution where several insoluble particles stand, such as enzymes, \textit{RNA} and metabolites.
...
In particular, this last one has the role of containing the genome, represented by the \textit{DNA}.
