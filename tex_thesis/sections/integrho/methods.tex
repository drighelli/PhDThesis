...
Thanks to the counts matrix form, we are able to apply the same methodologies designed for \textit{RNA-seq} data (see section \ref{sec:integrhorna} for further details).
...
As for the \textit{ChIP-seq}, the user need
