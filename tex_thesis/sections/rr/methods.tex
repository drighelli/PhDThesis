...
Additionally, our class methods are useful not only for the attributes manipulations but also for insertion of \glspl{cc}, comments and section titles inside the report.
