...
Finally, if we have identified a specific KEGG pathway which is of our interest, we can plot a \textit{KEGG map} representation with \lstinline!PlotKeggMapTimeCoursePathview!, which takes as input a data frame of relevant genes expression values for the interested pathway.
